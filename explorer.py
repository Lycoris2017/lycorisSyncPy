...
#print(tlu.iloc[0,:])
tlutrig0= tlu.iloc[0,:]['trigger'] # select 'trigger' at row=0
print("TLU first trigger starts at TID = ", tlutrig0)
duplication=tlu[tlu.duplicated(['trigger'])==True].sort_values('trigger')
print("\tAny repeated TLU trigger?", duplication.shape[0])
if duplication.shape[0]!=0 :
    print(duplication)
...
kpix = kpix.drop(kpix.index[:(tlutrig0-1)])
